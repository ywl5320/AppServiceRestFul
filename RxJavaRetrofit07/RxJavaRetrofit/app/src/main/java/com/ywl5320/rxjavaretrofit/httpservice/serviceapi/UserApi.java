...
public class UserApi extends BaseApi {
    ...
    public void chedkUpdate(String md5value, int versioncode, String channelid, Observer<UpdateBean> subscriber)
    {
        Observable observable = userService.chedkUpdate(md5value, versioncode, channelid)
                .map(new HttpResultFunc<UpdateBean>());
